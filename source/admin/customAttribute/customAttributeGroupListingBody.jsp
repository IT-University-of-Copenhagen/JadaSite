...
function submitNewForm(page) {
    document.forms[0].action = '/<c:out value='${adminBean.contextPath}'/>/admin/customAttribute/customAttributeGroupMaint.do';
...
<html:form action="/admin/customAttribute/customAttributeGroupListing.do" method="post">
<html:hidden property="process" value="list"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="jc_top_navigation">
  <tr> 
    <td>Item catalog - Custom Attribute Group Listing</td>
  </tr>
</table>
<br>
    ...
    <td width="0%" valign="top"> 
      <div class="jc_search_panel_open"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td class="jc_input_object"> <layout:text layout="false" property="srCustomAttribGroupName" mode="E,E,E" styleClass="jc_input_object"/> 
            </td>
          </tr>
          <tr> 
            <td>&nbsp; </td>
      ...
      <c:if test="${customAttributeGroupListingForm.customAttributeGroups != null}">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="1">
           <tr> 
            ...
            <td class="jc_list_table_header">Custom Attribute Group</td>
          </tr>
          <c:forEach var="customAttributeGroup" items="${customAttributeGroupListingForm.customAttributeGroups}">
          <tr class="jc_list_table_row"> 
            <td width="50" class="jc_list_table_content">
              <div align="center">
                <input type="checkbox" name="customAttribGroupIds" value="<c:out value="${customAttributeGroup.customAttribGroupId}"/>">
              </div>
            </td>
            <td width="300" class="jc_list_table_content">
              <html:link page="/admin/customAttribute/customAttributeGroupMaint.do?process=edit" paramId="customAttribGroupId" paramName="customAttributeGroup" paramProperty="customAttribGroupId">
                <c:out value="${customAttributeGroup.customAttribGroupName}"/>
              </html:link>
            </td>
          </tr>
          </c:forEach>
