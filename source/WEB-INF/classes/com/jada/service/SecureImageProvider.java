...
public class SecureImageProvider extends AdminAction {
    Logger logger = Logger.getLogger(SecureImageProvider.class);
    ...
    public ActionForward performAction(ActionMapping actionMapping,
        ...
        try {
        	...
        	byte data[] = Utility.getImage(request, type, id, maxsize);
