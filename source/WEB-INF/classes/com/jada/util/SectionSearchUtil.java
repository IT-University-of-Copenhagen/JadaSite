...
public class SectionSearchUtil {
	...
	static public void createSiteProfileClass(SiteProfileClass defaultSiteProfileClass, SiteProfileClass siteProfileClass, String siteId, String userId) throws Exception {
		...
		sql = NamedQuery.getInstance().getQuery("section.item.language.create");
		Query query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteProfileClass", defaultSiteProfileClass);
		query.executeUpdate();
	
		sql = NamedQuery.getInstance().getQuery("section.item.language.create1");
		query = em.createQuery(sql);
		query.setParameter("siteProfileClassId", siteProfileClass.getSiteProfileClassId());
		query.executeUpdate();
		
		sql = NamedQuery.getInstance().getQuery("section.content.language.create");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteProfileClass", defaultSiteProfileClass);
		query.executeUpdate();
	
		sql = NamedQuery.getInstance().getQuery("section.content.language.create1");
		query = em.createQuery(sql);
		query.setParameter("siteProfileClassId", siteProfileClass.getSiteProfileClassId());
		query.executeUpdate();
	}
	...
	static public void removeSiteProfileClass(String siteId, SiteProfileClass siteProfileClass) throws Exception {
		EntityManager em = JpaConnection.getInstance().getCurrentEntityManager();
		String sql = NamedQuery.getInstance().getQuery("section.item.language.remove");
		Query query = em.createQuery(sql);
		...
		sql = NamedQuery.getInstance().getQuery("section.content.language.remove");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteProfileClass", siteProfileClass);
		query.executeUpdate();
	...
	static public void createSiteCurrencyClass(SiteCurrencyClass defaultSiteCurrencyClass, SiteCurrencyClass siteCurrencyClass, String siteId, String userId) throws Exception {
		...
		sql = NamedQuery.getInstance().getQuery("section.item.price.create4");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteCurrencyClassId", defaultSiteCurrencyClass);
		query.executeUpdate();

		sql = NamedQuery.getInstance().getQuery("section.item.price.create5");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteCurrencyClassId1", defaultSiteCurrencyClass);
		query.executeUpdate();

		sql = NamedQuery.getInstance().getQuery("section.item.price.create");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteCurrencyClassId1", defaultSiteCurrencyClass);
		query.setParameter("siteCurrencyClassId2", defaultSiteCurrencyClass);
		query.executeUpdate();
	
		sql = NamedQuery.getInstance().getQuery("section.item.price.create2");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteCurrencyClassId1", defaultSiteCurrencyClass);
		query.setParameter("siteCurrencyClassId2", defaultSiteCurrencyClass);
		...
		sql = NamedQuery.getInstance().getQuery("section.item.price.create3");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.setParameter("siteCurrencyClassId1", defaultSiteCurrencyClass);
		query.setParameter("siteCurrencyClassId2", defaultSiteCurrencyClass);
		...
		sql = NamedQuery.getInstance().getQuery("section.item.price.create6");
		query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
		query.executeUpdate();

		sql = NamedQuery.getInstance().getQuery("section.item.price.create1");
		query = em.createQuery(sql);
	...
	static public void removeSiteCurrencyClass(String siteId, SiteCurrencyClass siteCurrencyClass) throws Exception {
		EntityManager em = JpaConnection.getInstance().getCurrentEntityManager();
		String sql = NamedQuery.getInstance().getQuery("section.item.price.remove");
		Query query = em.createQuery(sql);
		query.setParameter("siteId", siteId);
