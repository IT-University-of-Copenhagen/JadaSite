...
public class HomePageListingAction
    ...
    public ActionForward start(ActionMapping actionMapping,
    		...
    		throws Throwable {
        HomePageListingActionForm form = (HomePageListingActionForm) actionForm;
    ...
    public ActionForward list(ActionMapping actionMapping,
        ...
        if (form.getSrSiteName().length() > 0) {
        	sql += "and siteDomain.siteDomainLanguage.siteName like :siteName ";
        }
        ...
        if (form.getSrSiteName().length() > 0) {
        	query.setParameter("siteName", "%" + form.getSrSiteName() + "%");
        }
        if (form.getSrSiteDomainName().length() > 0) {
