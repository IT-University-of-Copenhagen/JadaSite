...
public class CategoryCustomAttributeOptionInfo {
	String customAttribOptionId;
	String customAttribValue;
	String customAttribUrl;
	int dataCount;
	...
	public String getCustomAttribUrl() {
		return customAttribUrl;
	}
	public void setCustomAttribUrl(String customAttribUrl) {
		this.customAttribUrl = customAttribUrl;
	}
}
