...
public class CategoryCustomAttributeInfo {
	String customAttribId;
	String customAttribDesc;
	boolean selected;
	CategoryCustomAttributeOptionInfo selectedCustomAttribOptionInfo;
	CategoryCustomAttributeOptionInfo customAttribOptionInfos[];
	...
	public CategoryCustomAttributeOptionInfo getSelectedCustomAttribOptionInfo() {
	...
	public CategoryCustomAttributeOptionInfo[] getCustomAttribOptionInfos() {
