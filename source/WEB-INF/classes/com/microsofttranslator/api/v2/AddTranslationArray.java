...
public class AddTranslationArray {
    ...
    @XmlElementRef(name = "translations", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class)
    ...
    public void setTranslations(JAXBElement<ArrayOfTranslation> value) {
        this.translations = ((JAXBElement<ArrayOfTranslation> ) value);
    }
